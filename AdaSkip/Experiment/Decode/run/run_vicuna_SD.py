...
from model.vicuna_SD import LlamaForCausalLM, MyVicunaConfig
...
def parse_args(args=None):
    ...
    parser.add_argument('--model', type=str, default="vicuna-SD-DECODE")
...
def load_model_and_tokenizer(path, SKIP_FULL_LAYER_NUM, device):
    ...
    config = MyVicunaConfig.from_pretrained(path, SKIP_FULL_LAYER_NUM=SKIP_FULL_LAYER_NUM)
