...
import sys
import os 
sys.path.append(os.path.abspath("/root/autodl-tmp/aaai-adaskip/models/internlm-7b-8k"))
...
class InternLMDecoderLayer(nn.Module):
    def __init__(self, config: InternLMConfig, layer_id: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class InternLMModel(InternLMPreTrainedModel):
    ...
    def __init__(self, config: InternLMConfig):
        ...
        self.layers = nn.ModuleList([InternLMDecoderLayer(config,layer_id) for layer_id in range(config.num_hidden_layers)])
