...
import torch
import json
from model.internlm_speed import InternLMForCausalLM
...
def parse_args(args=None):
    ...
    parser.add_argument('--model', type=str, default="internlm-SPEED")
...
def load_model(path, device):
    config = MyInternLMConfig.from_pretrained(path)
