...
from model.internlm_SD import InternLMForCausalLM
...
def parse_args(args=None):
    ...
    parser.add_argument('--model', type=str, default="internlm-SD-DECODE")
...
def get_pred(target_datasets, dataset2prompt, dataset2maxlen, device, model_name, model_path, output_dir, SKIP_FULL_LAYER_NUM):
    ...
    for target_dataset in target_datasets:
        ...
        model.model.MAX_GEN_LEN = max_gen
...
def load_model_and_tokenizer(path, SKIP_FULL_LAYER_NUM, device):
    ...
    config = MyInternLMConfig.from_pretrained(path, SKIP_FULL_LAYER_NUM=SKIP_FULL_LAYER_NUM)
