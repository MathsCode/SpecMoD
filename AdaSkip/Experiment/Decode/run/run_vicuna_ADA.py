...
from model.vicuna_ADA import LlamaForCausalLM, MyVicunaConfig
...
def parse_args(args=None):
    ...
    parser.add_argument('--model', type=str, default="vicuna-ADA-DECODE")
...
def load_model_and_tokenizer(path, SKIP_SUB_LAYER_NUM, device):
    ...
    config = MyVicunaConfig.from_pretrained(path, SKIP_SUB_LAYER_NUM=SKIP_SUB_LAYER_NUM)
...
if __name__ == '__main__':
    ...
    max_length = model2maxlen["vicuna"]
