...
import torch
import json
from model.llama_speed import LlamaForCausalLM, MyLlamaConfig
import numpy as np
import random
import argparse
...
def parse_args(args=None):
    ...
    parser.add_argument('--model', type=str, default="llama-SPEED")
...
def load_model(path, device):
    config = MyLlamaConfig.from_pretrained(path)
