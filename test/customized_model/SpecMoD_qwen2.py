...
import sys
sys.path.append("/home/xujiaming/xujiaming/Paper/NIPS_SpecMoD/test/customized_model")
from SpecMoD_utils import SpecMoD_GenerationMixin
...
class Qwen2ForCausalLM(Qwen2PreTrainedModel, SpecMoD_GenerationMixin):
