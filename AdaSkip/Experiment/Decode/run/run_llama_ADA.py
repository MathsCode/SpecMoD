...
from model.llama_ADA import LlamaForCausalLM, MyLlamaConfig
...
def parse_args(args=None):
    ...
    parser.add_argument('--model', type=str, default="llama-ADA-DECODE")
...
def load_model_and_tokenizer(path, SKIP_SUB_LAYER_NUM, device):
    ...
    config = MyLlamaConfig.from_pretrained(path, SKIP_SUB_LAYER_NUM=SKIP_SUB_LAYER_NUM)
