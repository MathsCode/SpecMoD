...
class InternLMModel(InternLMPreTrainedModel):
    ...
    def forward(
        ...
        self.attn_ffn_time_sums = [0.0, 0.0]
        torch.cuda.synchronize()
        all_layer_start_event = torch.cuda.Event(enable_timing=True)
        all_layer_end_event = torch.cuda.Event(enable_timing=True)
        all_layer_start_event.record()
        ...
        all_layer_end_event.record()
        torch.cuda.synchronize()
        print(f"ALL LAYER: {all_layer_start_event.elapsed_time(all_layer_end_event):.2f} ms")
